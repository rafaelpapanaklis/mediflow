...
-- CreateTable
CREATE TABLE "barber_appointment_services" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "barber_client_memberships" (
    "id" TEXT NOT NULL,
    "barbershopId" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "barber_sale_items" (
    "id" TEXT NOT NULL,
...
-- CreateTable
CREATE TABLE "barber_cash_sessions" (
    "id" TEXT NOT NULL,
    "barbershopId" TEXT NOT NULL,
...
-- CreateIndex
CREATE UNIQUE INDEX "barber_shops_slug_key" ON "barber_shops"("slug");

-- CreateIndex
CREATE INDEX "barber_shops_parentId_idx" ON "barber_shops"("parentId");

-- CreateIndex
CREATE INDEX "barber_users_supabaseId_idx" ON "barber_users"("supabaseId");

-- CreateIndex
CREATE INDEX "barber_users_barbershopId_idx" ON "barber_users"("barbershopId");

-- CreateIndex
CREATE UNIQUE INDEX "barber_users_supabaseId_barbershopId_key" ON "barber_users"("supabaseId", "barbershopId");

-- CreateIndex
CREATE INDEX "barber_barbers_barbershopId_isActive_idx" ON "barber_barbers"("barbershopId", "isActive");

-- CreateIndex
CREATE INDEX "barber_clients_barbershopId_phone_idx" ON "barber_clients"("barbershopId", "phone");

-- CreateIndex
CREATE INDEX "barber_clients_barbershopId_name_idx" ON "barber_clients"("barbershopId", "name");

-- CreateIndex
CREATE INDEX "barber_services_barbershopId_isActive_idx" ON "barber_services"("barbershopId", "isActive");

-- CreateIndex
CREATE INDEX "barber_appointments_barbershopId_startAt_idx" ON "barber_appointments"("barbershopId", "startAt");

-- CreateIndex
CREATE INDEX "barber_appointments_barberId_startAt_idx" ON "barber_appointments"("barberId", "startAt");

-- CreateIndex
CREATE INDEX "barber_appointments_barbershopId_status_idx" ON "barber_appointments"("barbershopId", "status");

-- CreateIndex
CREATE INDEX "barber_appointment_services_appointmentId_idx" ON "barber_appointment_services"("appointmentId");

-- CreateIndex
CREATE INDEX "barber_appointment_services_serviceId_idx" ON "barber_appointment_services"("serviceId");

-- CreateIndex
CREATE INDEX "barber_walkins_barbershopId_status_position_idx" ON "barber_walkins"("barbershopId", "status", "position");

-- CreateIndex
CREATE INDEX "barber_walkins_barbershopId_joinedAt_idx" ON "barber_walkins"("barbershopId", "joinedAt");

-- CreateIndex
CREATE INDEX "barber_memberships_barbershopId_isActive_idx" ON "barber_memberships"("barbershopId", "isActive");

-- CreateIndex
CREATE INDEX "barber_client_memberships_barbershopId_status_idx" ON "barber_client_memberships"("barbershopId", "status");

-- CreateIndex
CREATE INDEX "barber_client_memberships_clientId_idx" ON "barber_client_memberships"("clientId");

-- CreateIndex
CREATE INDEX "barber_client_memberships_membershipId_idx" ON "barber_client_memberships"("membershipId");

-- CreateIndex
CREATE INDEX "barber_sales_barbershopId_createdAt_idx" ON "barber_sales"("barbershopId", "createdAt");

-- CreateIndex
CREATE INDEX "barber_sales_barberId_createdAt_idx" ON "barber_sales"("barberId", "createdAt");

-- CreateIndex
CREATE INDEX "barber_sales_cashSessionId_idx" ON "barber_sales"("cashSessionId");

-- CreateIndex
CREATE INDEX "barber_sale_items_saleId_idx" ON "barber_sale_items"("saleId");

-- CreateIndex
CREATE INDEX "barber_products_barbershopId_isActive_idx" ON "barber_products"("barbershopId", "isActive");

-- CreateIndex
CREATE INDEX "barber_cash_sessions_barbershopId_openedAt_idx" ON "barber_cash_sessions"("barbershopId", "openedAt");

-- CreateIndex
CREATE INDEX "barber_commission_entries_barbershopId_periodKey_idx" ON "barber_commission_entries"("barbershopId", "periodKey");

-- CreateIndex
CREATE INDEX "barber_commission_entries_barberId_periodKey_idx" ON "barber_commission_entries"("barberId", "periodKey");

-- CreateIndex
CREATE INDEX "barber_messages_barbershopId_createdAt_idx" ON "barber_messages"("barbershopId", "createdAt");

-- CreateIndex
CREATE INDEX "barber_messages_barbershopId_phone_idx" ON "barber_messages"("barbershopId", "phone");

-- CreateIndex
CREATE INDEX "barber_messages_waMessageId_idx" ON "barber_messages"("waMessageId");
