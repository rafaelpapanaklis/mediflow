...
test("el modelo recibe las diez de consulta, las de agenda, pacientes y dinero, la de caja, las tres de clínico y la del odontograma, con su esquema", async () => {
  ...
  assert.deepEqual(
    ...
    [...LAS_DIEZ, ...LAS_NUEVAS, ...LAS_DE_CAJA, ...LAS_DE_CLINICO, ...LA_DEL_ODONTOGRAMA].sort(),
  );
