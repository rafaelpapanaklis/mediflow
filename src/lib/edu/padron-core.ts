...
/** Texto que se le pinta a quien abrió el padrón y no le toca ninguna fila. */
export const EDU_SCOPE_NONE_DETAIL =
  "Tu rol no lista alumnos. El padrón lo ven la dirección (todos) y los docentes (los suyos). Si necesitas verlo, pídele a la dirección que revise tu rol.";
