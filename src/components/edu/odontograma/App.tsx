...
/* ═══════════════════════════════════════════════════════════════════════
 * COPIA DEL INSTITUTO del odontograma v2 — ARCHIVO QUE NO SE USA AQUÍ.
 *
 * Origen: la carpeta del odontograma v2 bajo src/components/dashboard/ (el vertical DENTAL).
 * Vino con la carpeta entera para que la bifurcación esté COMPLETA y
 * nadie tenga que ir a buscar la mitad que falta al vertical de al lado.
 *
 * ⛔ PERO ESTE ARCHIVO NO LO IMPORTA NADIE DEL INSTITUTO, Y NO DEBE.
 * Es la raíz acoplada al dental: habla con `/api/odontogram`, que resuelve
 * contra la tabla `odontogram_entries` del PRODUCTO DENTAL con la sesión
 * del dental. Usarlo desde /instituto escribiría los hallazgos de un
 * paciente de una escuela en el expediente de una clínica que no es suya
 * — o simplemente contestaría 401 y parecería un fallo de red.
 *
 * El contenedor del vertical es
 * src/components/edu/expediente/odontograma-screen.tsx, que escribe en
 * /api/instituto/pacientes/[id]/odontograma con el institutionId de la
 * sesión y el alcance clínico del rol. Ése es el que se toca.
 * ═══════════════════════════════════════════════════════════════════════ */
