...
import {
  ...
  CreditCard, BarChart3, Monitor, UserCog, Globe, ClipboardList, Settings, Megaphone,
...
const NAV_ITEMS: NavItemDef[] = [
  ...
  { id: "marketing",      section: "admin", label: "Marketing",         href: "/dashboard/marketing",     icon: Megaphone, adminOnly: true },
