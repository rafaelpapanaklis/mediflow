...
const NAV_ITEMS: NavItem[] = [
  { href: "/proveedores/inicio",        label: "Inicio",        icon: Home },
  { href: "/proveedores/productos",     label: "Productos",     icon: Package },
  { href: "/proveedores/pedidos",       label: "Pedidos",       icon: ClipboardList },
  { href: "/proveedores/chats",         label: "Chats",         icon: MessageCircle },
  { href: "/proveedores/configuracion", label: "Configuración", icon: Settings },
];
...
export function SupplierSidebar({
  ...
  async function handleLogout() {
    try {
      await fetch("/api/proveedores/auth/logout", { method: "POST" });
    } finally {
      ...
      >
        ...
        <div className="sidebar-new__brand">
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            ...
            <div className="sidebar-new__brandsub">Proveedor</div>
          </div>
          <button
            type="button"
            onClick={() => setMobileOpen(false)}
