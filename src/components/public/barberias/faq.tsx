 ...
 * el FAQPage del JSON-LD: Google exige que lo marcado sea lo visible.
 */
export function BarberFaq({ t, items }: { t: TFunction; items: BarberFaqItem[] }) {
  return (
    <section className="dcbl-section dcbl-section--tight" id={BARBER_LANDING_ANCHORS.faq}>
