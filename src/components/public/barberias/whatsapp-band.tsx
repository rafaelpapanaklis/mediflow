 ...
 * salen de la tabla. Se imprime como un recibo de papel, igual que el
 * ticket de la portada.
 */
export function BarberWhatsappBand({
  ...
  return (
    <section className="dcbl-section dcbl-wa dcbl-dark dcbl-grain" id={BARBER_LANDING_ANCHORS.whatsapp}>
      <div className="dcbl-wrap">
        <div className="dcbl-wa__grid">
          <div>
            ...
            <ul className="dcbl-wa__points">
              {BARBER_LANDING_WA_POINTS.map((p, i) => {
                const requiredPlan = barberPlanRequiredFor(plans, p.feature);
                return (
                  <li key={p.key} data-reveal="" style={rd(i * 50)}>
                    <span className="dcbl-wa__point-icon">
          ...
          <aside className="dcbl-cost" aria-labelledby="dcbl-cost-title" data-reveal="" style={rd(120)}>
