...
export const metadata: Metadata = {
  title: "Programas y generaciones · DaleControl Institucional",
 ...
 * COINCIDE MÁS, así que estar aquí enciende "Programas y generaciones" y no
 * "Padrón".
 */
  ...
  return (
    <div className="edu-page">
      <header className="edu-pagehead">
        <div>
          <h1 className="edu-page__title">Programas y generaciones</h1>
