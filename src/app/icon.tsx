...
// Favicon DaleControl: isotipo = cuadrado violeta de marca + diente blanco.
// El fondo replica EXACTO el de .mfh-logo__mark (sales.css):
// linear-gradient(150deg, var(--b) #7c3aed 0%, var(--b2) #6d28d9 100%).
