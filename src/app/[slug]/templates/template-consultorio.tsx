...
export function TemplateConsultorio({ clinic: publicada }: TemplateProps) {
  ...
  return (
    <div style={{ fontFamily: "var(--font-sans)", color: tinta, background: "#fff", fontSize: 16, lineHeight: 1.6 }}>
              ...
              {datos.map(d => (
                <div key={d.etiqueta} style={{
                  ...
                  <Txt as="span" style={{ fontSize: 13.5, color: d.destacado ? alpha(avisoInk, 0.75) : tint(acento, 0.75) }}
                    campo={d.clave ? dirCopia(d.clave) : null}
          ...
          <div className="co-wrap">
            ...
            <div style={{ border: `1px solid ${linea}`, borderRadius: 10, overflow: "hidden", marginTop: 26 }}>
              <div className="co-cab" style={{
                ...
                <Txt as="span" campo={dirCopia("servicios.colTratamiento")}
                  valor={C("servicios.colTratamiento")} porDefecto="Tratamiento" /><Txt as="span" campo={dirCopia("servicios.colDuracion")}
                  valor={C("servicios.colDuracion")} porDefecto="Duración" /><Txt as="span" campo={dirCopia("servicios.colPrecio")}
              ...
              <div style={{ display: "flex", gap: 10, flexWrap: "wrap", marginTop: 18 }}>
                ...
                {clinic.phone && (
                  <Txt as="a" style={{ ...btnO, ...btnSm }} href={`tel:${clinic.phone}`}
                    campo={dirCopia("contacto.llamar")}
      ...
      <section style={{ background: acento, color: "#fff", padding: "56px 0", textAlign: "center" }}>
        <div className="co-wrap">
          ...
          <Txt as="button" type="button" onClick={() => abrir()} style={btnA}
            ...
            valor={C("reservar.cta")} porDefecto="Agendar mi cita" sufijo=" →" unido />
        </div>
      </section>
      ...
      {wa && (
        <Txt as="a" href={wa} target="_blank" rel="noopener noreferrer"
          ...
          campo={dirCopia("flotante.whatsapp")}
          valor={C("flotante.whatsapp")} porDefecto="WhatsApp" prefijo=" " unido
          antes={<MessageCircle size={22} />} />
      )}
