...
export function LandingConfigClient({ clinic: initial, appUrl }: Props) {
  ...
  return (
    <div className="flex-1 min-w-0 p-4 sm:p-6 space-y-5 max-w-4xl">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="flex items-center gap-2">
          ...
          <a href={landingUrl} target="_blank" rel="noreferrer"
            className="flex items-center gap-1.5 text-sm font-semibold text-brand-600 border border-brand-300 px-3 py-2 rounded-xl hover:bg-brand-50">
      ...
      {/* Link preview */}
      <div className="bg-brand-50 dark:bg-brand-900/20 border border-brand-200 dark:border-brand-800 rounded-xl px-4 py-3 flex items-center justify-between gap-3">
        <div>
