...
export default async function BillingPage() {
  ...
  const invoices = await prisma.invoice.findMany({ where: { clinicId: user.clinicId }, include: { patient: { select: { id: true, firstName: true, lastName: true } }, payments: true }, orderBy: { createdAt: "desc" }, take: 50 });
