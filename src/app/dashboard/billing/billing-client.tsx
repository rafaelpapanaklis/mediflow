          ...
          <form onSubmit={createInvoice} className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            ...
            <div className="col-span-2 space-y-1">
              ...
              <input className="flex h-10 w-full rounded-lg border border-border bg-white px-3 text-sm focus:outline-none"
                placeholder="Consulta dental…" value={form.description} onChange={e => set("description", e.target.value)} />
            </div>
            ...
            <div className="space-y-1">
              ...
              <input type="number" min="0" className="flex h-10 w-full rounded-lg border border-border bg-white px-3 text-sm focus:outline-none"
                placeholder="500" value={form.unitPrice} onChange={e => set("unitPrice", e.target.value)} />
            </div>
            <div className="space-y-1">
            ...
            <div className="space-y-1">
              ...
              <input className="flex h-10 w-full rounded-lg border border-border bg-white px-3 text-sm focus:outline-none"
                placeholder="Opcional" value={form.notes} onChange={e => set("notes", e.target.value)} />
            </div>
            ...
            {invoices.length === 0 ? (
              <tr>
                <td colSpan={7} className="px-5 py-16 text-center text-muted-foreground text-sm">
                  No hay facturas aún. <button onClick={() => setShowNew(true)} className="text-brand-600 hover:underline">Crear primera factura →</button>
                </td>
              </tr>
            ) : invoices.map(inv => {
