...
export default async function AffiliatePendingPage() {
  ...
  if (ctx.status === "REJECTED") {
    ...
    copy = {
      ...
      body:
        "El acceso de tu cuenta de afiliado ha sido suspendido. Contacta al equipo de MediFlow para más información sobre cómo restablecerlo.",
      tone: "danger",
    };
  } else {
    copy = {
      ...
      body:
        "El equipo de MediFlow revisará tu solicitud y recibirás acceso al panel de afiliados en cuanto sea aprobada. Te notificaremos por correo cuando esté lista.",
      tone: "neutral",
    };
  }
